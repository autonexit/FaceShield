...
![نمای محیط برنامه](docs/ui_screenshot.png)
...
### 🔹 تصویر اصلی (قبل از محوسازی)

![قبل از پردازش](docs/before_frame.png)

---

### 🔹 تصویر خروجی (بعد از محوسازی چهره‌ها)

![بعد از پردازش](docs/after_frame.png)

---

## 🖥 نحوه ساخت فایل اجرایی (EXE)

برای تولید نسخه اجرایی ویندوز:

```bash
pyinstaller --noconsole --onedir --name "FaceShieldAI_POWEREN" app.py
